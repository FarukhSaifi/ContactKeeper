...
import { UI_COPY } from "../../constants/app";
          ...
          <div className="space-y-6 text-gray-600 dark:text-gray-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg text-center">
                <span className="text-purple-600 dark:text-purple-400 font-medium">Material-UI v5</span>
              </div>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg text-center">
                <span className="text-orange-600 dark:text-orange-400 font-medium">React Router v6</span>
              </div>
